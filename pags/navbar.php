<!-- pags/navbar.php -->
<!-- quick-fix: carregando Tailwind direto aqui -->
...
<nav class="bg-white shadow-md fixed w-full z-10">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      ...
      <div class="hidden md:flex space-x-8 items-center">
        ...
        <a href="home.php" class="text-gray-700 hover:text-blue-600 font-medium">Prestadores</a>
  ...
  <div id="mobile-menu" class="hidden md:hidden bg-white border-t shadow-md">
    ...
    <a href="home.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Prestadores</a>
    ...
    <a href="login.php" class="block px-4 py-2 text-blue-600 font-medium hover:bg-gray-100">Entrar</a>
  </div>
</nav>
