...
<body class="bg-gradient-to-br from-blue-50 via-white to-indigo-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        ...
        <div class="hidden md:flex space-x-6 items-center">
          ...
          <a href="perfil_cliente.php" class="text-blue-600 font-semibold border-b-2 border-blue-600 pb-1">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">
          <i class="fas fa-user-cog text-blue-600 mr-3"></i>Meu Perfil
        </h1>
        <p class="text-xl text-gray-600">Gerencie suas informações pessoais</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-1">
          <div class="bg-white rounded-2xl shadow-lg p-4 border border-gray-100 sticky top-24">
            <nav class="space-y-2">
              <button class="tab-nav w-full text-left px-4 py-3 rounded-xl bg-blue-100 text-blue-600 font-semibold transition-colors" data-tab="dados">
        ...
        <div class="md:col-span-3 space-y-6">
          ...
          <div id="dados-tab" class="tab-content bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Dados Pessoais</h2>
            ...
            <form id="form-dados" class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="nome" name="nome" value="<?php echo htmlspecialchars($cliente['nome']); ?>" 
                         required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
          ...
          <div id="endereco-tab" class="tab-content hidden bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Endereço</h2>
            ...
            <form id="form-endereco" class="space-y-6">
              ...
              <div class="bg-blue-50 rounded-xl p-4 border border-blue-200">
                <p class="text-sm text-blue-700">
                  ...
                  Seu endereço é usado para mostrar prestadores mais próximos de você.
                </p>
              </div>
            ...
            <div class="space-y-6">
              <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                <div>
                  ...
                  <p class="text-sm text-gray-600">Receba avisos sobre ofertas e atualizações</p>
                </div>
              ...
              <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                <div>
                  <h3 class="font-semibold text-gray-800">Sugestões Personalizadas</h3>
                  <p class="text-sm text-gray-600">Recomendações baseadas no seu histórico</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" class="sr-only peer" checked>
                  <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              ...
              <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                <div>
                  <h3 class="font-semibold text-gray-800">Vendas e Promoções</h3>
                  <p class="text-sm text-gray-600">Ofertas exclusivas e descontos especiais</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
          ...
          <div id="seguranca-tab" class="tab-content hidden bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
              ...
              <p class="text-gray-600 mb-4">Uma vez deletada, não há como recuperar sua conta.</p>
  ...
  <script>
    ...
    document.getElementById('form-dados').addEventListener('submit', function(e) {
      ...
      fetch('processa_perfil_cliente.php', {
        method: 'POST',
        headers: {
    ...
    document.getElementById('form-endereco').addEventListener('submit', function(e) {
      ...
      .then(data => {
        if (data.success) {
          ...
          alert('Erro ao atualizar endereço: ' + data.error);
        }
      })
      .catch(error => console.error('Erro:', error));
    });
    ...
    function deletarConta() {
      if (confirm('Tem CERTEZA que deseja deletar sua conta? Esta ação é irreversível!')) {
        if (confirm('Última confirmação: Todos os seus dados serão perdidos permanentemente. Deseja continuar?')) {
          fetch('processa_perfil_cliente.php', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
    ...
    function createMobileMenu() {
      ...
      menu.innerHTML = `
        ...
        <a href="perfil_cliente.php" class="block px-4 py-2 text-blue-600 font-medium hover:bg-gray-100">
          <i class="fas fa-user-cog mr-2"></i>Perfil
        </a>
