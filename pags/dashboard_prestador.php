        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <div class="space-y-3">
              ...
              <button class="w-full bg-blue-600 text-white py-3 px-4 rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center">
                <i class="fas fa-plus mr-2"></i>Adicionar Serviço
              </button>
              
              <button class="w-full bg-purple-600 text-white py-3 px-4 rounded-xl hover:bg-purple-700 transition-colors flex items-center justify-center">
